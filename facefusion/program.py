...
def create_frame_extraction_program() -> ArgumentParser:
	...
	group_frame_extraction.add_argument('--frame-start', help = wording.get('help.frame_start'), type = int, default = None)
	group_frame_extraction.add_argument('--frame-end', help = wording.get('help.frame_end'), type = int, default = None)
	job_store.register_step_keys([ 'trim_frame_start', 'trim_frame_end', 'temp_frame_format', 'keep_temp', 'frame_start', 'frame_end' ])
	return program
